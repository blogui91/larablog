<?php namespace Modules\Categories\Src\Controllers\Admin;
...
class CategoriesController extends Controller
{
    ...
    protected function showForm($mode, $id = null)
    {
        ...
        // Show the page
        return view('Categories.form', compact('mode', 'category'));
    }
    ...
    protected function processForm($mode, $id = null)
    {
        ...
        if ($messages->isEmpty()) {
            return redirect()->route('admin.categories.all')->with('success', trans("platform/roles::message.success.{$mode}"));
        }
