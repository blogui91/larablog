<?php namespace Modules\Tags\Src\Controllers\Admin;
...
class TagsController extends Controller
{
    ...
    protected function showForm($mode, $id = null)
    {
        ...
        // Show the page
        return view('Tags.form', compact('mode', 'tag'));
    }
    ...
    protected function processForm($mode, $id = null)
    {
        ...
        if ($messages->isEmpty()) {
            return redirect()->route('admin.tags.all')->with('success', trans("platform/roles::message.success.{$mode}"));
        }
